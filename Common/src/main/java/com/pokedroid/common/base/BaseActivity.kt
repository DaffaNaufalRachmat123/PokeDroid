...
import com.pokedroid.common.utils.ThemeManager
...
abstract class BaseActivity<VM : ViewModel> : AppCompatActivity, CoroutineScope {
    ...
    val db by inject<DatabaseProvider>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ThemeManager.getThemeStyle()
            .let(ThemeManager::valueToModeMapper)
            .let(ThemeManager::applyTheme)
