package com.pokedroid.common.view
...
import com.pokedroid.common.extension.getResColor
...
class LoadingDots : LinearLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        mDotsColor = a.getColor(R.styleable.LoadingDots_LoadingDots_dots_color, context.getResColor(R.color.colorPrimary))
    ...
    fun setDotsColorRes(colorRes: Int) {
        dotsColor = context.getResColor(colorRes)
    }
