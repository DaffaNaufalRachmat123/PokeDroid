...
fun Context.openInBrowser(uri: Uri) {
    ...
    val customTabsIntent = Intent(Intent.ACTION_VIEW, uri)
//
//        CustomTabsIntent.Builder()
//        .setShowTitle(true)
//        .setInstantAppsEnabled(false)
//        .build()
    customTabsIntent.addFlags(FLAG_ACTIVITY_NEW_TASK)
    customTabsIntent.addFlags(FLAG_ACTIVITY_CLEAR_TASK)
...
private fun Context.setDeepLinkingState(state: Int) {
    applicationContext.packageManager.setComponentEnabledSetting(
        ComponentName(packageName, "com.androidpk.pergikuliner.deeplink.DeepLinkActivity"),
        state,
